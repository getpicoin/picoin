...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // PiCoin: starting difficulty is 1 / 2^12
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // PiCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
